...
function get_simulated_data (model, watershed, subbasin, streamcomid, startdate, stationcode, stationname) {
...
function get_hydrographs (model, watershed, subbasin, streamcomid, startdate, stationcode, stationname) {
...
function get_dailyAverages (model, watershed, subbasin, streamcomid, startdate, stationcode, stationname) {
...
function get_scatterPlot (model, watershed, subbasin, streamcomid, startdate, stationcode, stationname) {
...
function get_scatterPlotLogScale (model, watershed, subbasin, streamcomid, startdate, stationcode, stationname) {
...
function get_volumeAnalysis (model, watershed, subbasin, streamcomid, startdate, stationcode, stationname) {
...
function createVolumeTable(model, watershed, subbasin, streamcomid, startdate, stationcode, stationname) {
	$('#volumeAnalysis-loading').removeClass('hidden');
	m_downloaded_historical_streamflow = true;
    $.ajax({
    ...
    map.on("singleclick", function(evt) {
        ...
        if (map.getTargetElement().style.cursor == "pointer") {
            ...
            if (model === 'ECMWF-RAPID') {
                ...
                if (current_layer["H"]["source"]["i"]["LAYERS"] == "IDEAM_Stations") {
                	...
                	$.ajax({
                        ...
                        success: function (result) {
                        	...
                        	areaBasinObs = result["features"][0]["properties"]["Basin_Stat"];
                        	areaBasinSim = result["features"][0]["properties"]["Basin_Simu"];
                        	$('#obsdates').removeClass('hidden');
                        	...
                        	get_simulated_data (model, watershed, subbasin, streamcomid, startdate, stationcode, stationname);
                        	get_hydrographs (model, watershed, subbasin, streamcomid, startdate, stationcode, stationname);
                        	get_dailyAverages (model, watershed, subbasin, streamcomid, startdate, stationcode, stationname);
                        	get_scatterPlot (model, watershed, subbasin, streamcomid, startdate, stationcode, stationname);
                        	get_scatterPlotLogScale (model, watershed, subbasin, streamcomid, startdate, stationcode, stationname);
                        	get_volumeAnalysis (model, watershed, subbasin, streamcomid, startdate, stationcode, stationname);
                        	createVolumeTable(model, watershed, subbasin, streamcomid, startdate, stationcode, stationname);
                        }
                    });
                }
...
$(function() {
   ...
   $('#startdateobs').change(function() { //when date is changed
    ...
    $('#enddateobs').change(function() { //when date is changed
        ...
        $('#observed-loading-Q').removeClass('hidden');
        $('#simulated-loading-Q').removeClass('hidden');
        $('#hydrograph-loading').removeClass('hidden');
        $('#dailyAverages-loading').removeClass('hidden');
        $('#scatterPlot-loading').removeClass('hidden');
        $('#scatterPlotLogScale-loading').removeClass('hidden');
        $('#volumeAnalysis-loading').removeClass('hidden');
