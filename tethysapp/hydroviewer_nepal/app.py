    ...
    def url_maps(self):
        ...
        url_maps = (
            ...
            UrlMap(
                name='ecmwf',
                url='ecmwf-rapid',
                controller='{0}.controllers.lis_ecmwf'.format(base_name)),
            UrlMap(
                name='lis',
                url='lis-rapid',
                controller='{0}.controllers.lis_ecmwf'.format(base_name)),
            ...
            UrlMap(
                name='get-historic-data',
                url='lis-rapid/get-historic-data',
                controller='{0}.controllers.get_historic_data'.format(base_name)),
            UrlMap(
                name='get-flow-duration-curve',
    ...
    def custom_settings(self):
        return (
            ...
            CustomSetting(
                name='sldas_source',
                type=CustomSetting.TYPE_STRING,
                description='Tethys portal where SLDAS Explorer is installed',
                required=False
                ),
            CustomSetting(
                name='sldas_token',
                type=CustomSetting.TYPE_STRING,
                description='Unique token to access data from the SLDAS Explorer',
                required=False
                ),
            CustomSetting(
                name='geoserver',
