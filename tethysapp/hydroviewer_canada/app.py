...
class Hydroviewer(TethysAppBase):
    ...
    name = 'HydroViewer Canada'
    index = '{0}:home'.format(base_name)
    icon = '{0}/images/canada-icon.jpeg'.format(base_name)
    package = '{0}'.format(base_name)
    root_url = base_url
    color = '#D80621'
    description = 'This is the Hydroviewer App customized for Canada.'
    tags = '"Hydrology", "GEOGloWS", "Hydroviewer", "Canada"'
    ...
    def custom_settings(self):
        return (
            ...
            CustomSetting(
                ...
                required=True,
                default='-104.895627,57.479509,3',
            ),
            CustomSetting(
