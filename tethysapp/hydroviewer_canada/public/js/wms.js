...
function get_discharge_info (stationcode, stationname, startdateobs, enddateobs, province) {
    $('#observed-loading-Q').removeClass('hidden');
    $.ajax({
        url: 'get-discharge-data',
        type: 'GET',
        data: {'stationcode' : stationcode, 'stationname' : stationname, 'startdateobs' : startdateobs, 'enddateobs' : enddateobs, 'province': province,},
        error: function () {
...
function get_waterlevel_info (stationcode, stationname, startdateobs, enddateobs, province) {
                ...
                if (current_layer["H"]["source"]["i"]["LAYERS"] == "Stations_Canada_RT") {
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                ...
                                $("#station-info").append('<h3>Current Station: '+ stationname + '</h3><h5>Station Code: '+ stationcode + '</h5><h5>Province: '+ province + '</h5>');
                                get_discharge_info (stationcode, stationname, startdateobs, enddateobs, province);
                                get_waterlevel_info (stationcode, stationname, startdateobs, enddateobs, province);
