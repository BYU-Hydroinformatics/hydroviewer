    ...
    map.on("singleclick", function(evt) {
        ...
        if (map.getTargetElement().style.cursor == "pointer") {
            ...
            if (model === 'ECMWF-RAPID') {
                ...
                if (current_layer["H"]["source"]["i"]["LAYERS"] == "WHOS_LaPlata") {
                        ...
                        $.ajax({
                            ...
                            dataType: 'json',
                            success: function (result) {
                                stationcode = result["features"][0]["properties"]["sitecode"];
                                stationname = result["features"][0]["properties"]["sitename"];
                                $('#obsdates').removeClass('hidden');
